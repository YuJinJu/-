...
<%@ include file="./include/header.jsp"%>
         ...
         <div class="card col-sm-12 mt-1" style="min-height: 850px;">
            ...
            <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=18643427fad3e2f692d81674f6a813b3&libraries=services"></script>
...
/*                               <tr class="${colorArr[index%3]}">
            ...
            $(document).on("click", "#aptSearchBtn", function() {
               var param = {
                     serviceKey:'Jxb+SSvi+ZKcATLr56pECHx1nXrBH2BcJpaAQouMk1Wq+Qf0Whf3rscro2xRc1MvmWa7dRaBY65qgqPJIy2HOg==',
